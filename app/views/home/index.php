...
<div class="well well-sm">
  ...
  <div style="border-bottom: 1px solid #e7e7e7;">
    <div class="container-fluid">
      <div class="text-center">
        ...
        <img src="<?= Setting::unique(['name' => 'image_logo_emblem'])->value; ?>" style="width: 80px; height: 80px;"/>
        <h2>
          <?= Setting::unique(["name" => "site_title_short"])->value; ?> İLE TOHUM ÇÖZÜMLERİ <b id="js-rotating">HIZLI, SÜREKLİ, PRATİK, KARARLI</b><br/>
        </h2>

        <h4>
          ve her gün daha iyisi olmak için çalışıyoruz!<br/><br/>
          <a href="/home/about_us" class="btn btn-success" role="button">
            <?= Setting::unique(["name" => "site_title_short"])->value; ?> <?= t("home.about"); ?>
          </a>
        </h4>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <a href="/home/products/show/<?= $product->id; ?>" class="btn btn-success pull-right" role="button">
  ...
  <center>
    <h4>
      ...
      satışını yaptığı tüm ürünlerin projelendirilmesini <br/>
      uzman ekibiyle yapmaktadır. <br/>
    </h4>
    <a href="/home/products" class="btn btn-success" role="button">
      <?= t("home.our_products"); ?>
    </a>
  </center>
</div>
