...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-md-2 hidden-sm hidden-xs">
      <img src="<?= Setting::unique(['name' => 'image_logo_emblem'])->value; ?>" style="width: 150px; height: 150px;" />
    </div>
    <div class="col-md-10 col-sm-12 col-xs-12" style="border-left: 2px solid #ddd;">
      ...
      <?php } else if ($locale == "en")  { ?>
        <?= Setting::unique(["name" => "site_about_en"])->value; ?>
      <?php } ?>
    </div>
  </div>
  ...
  <div class="row">
    <?php $users = User::load()->order("updated_at", "asc")->get_all(); ?>
